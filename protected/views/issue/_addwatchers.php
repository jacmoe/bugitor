...
echo CHTML::dropDownList('add_watcher', '', $nonwatcherslist).PHP_EOL; //$model->getNonWatchersList();
...
echo CHTML::beginForm('#').PHP_EOL;
echo CHTML::dropDownList('remove_watcher', '', $watcherslist).PHP_EOL; //$model->getNonWatchersList();
