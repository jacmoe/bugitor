...
function run($postBody, $headers) {
    ...
    $secret = 'Tdax2Ex9QrVircMTLvJT4SCH3F5XDRPk';//getenv('WEBHOOK_SECRET');
    ...
    if ($payload->repository->url == 'https://github.com/jacmoe/bugitor-pages'
        ...
        passthru('/usr/local/php56/bin//php /home/jacmoe/webdev/vhosts/bugitor/current/yii mdpages/pages/update');
