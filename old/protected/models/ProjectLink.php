...
class ProjectLink extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('url, title, description, position, project_id', 'required'),
            array('position, project_id', 'numerical', 'integerOnly'=>true),
            array('url, title, description', 'length', 'max'=>255),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, url, title, description, position, project_id', 'safe', 'on'=>'search'),
        );
    }
